...
const PokemonListItem = ({pokemon}) => {
    ...
    return (
        ...
        <ListItem
            containerStyle={[styles.cardStyle, {backgroundColor: colors[0], borderColor: colors[1]},]}
        >
            <View
                style={[]}
            >
...
const styles = StyleSheet.create({
    cardStyle: {borderRadius: 20, margin: 8}, ListTitle: {
        paddingBottom: 15, fontSize: 25, textTransform: 'capitalize', justifyContent: 'space-between',

    }, avatar: {
        borderRadius: 20, borderWidth: 6, alignItems: 'flex-start',
    }, types: {
        borderRadius: 10, padding: 8, borderWidth: 1, marginRight: 5,
    }, textTypes: {
